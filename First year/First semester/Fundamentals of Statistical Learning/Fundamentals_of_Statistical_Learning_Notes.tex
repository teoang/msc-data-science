...
Roll a fair six-sided die and let $X$ be the number shown. Then
\[
  p_X(x)=
  \begin{cases}
  ...
  \end{cases}
\]
The support is $\operatorname{supp}(X)=\{1,2,3,4,5,6\}$, since each
of these values has positive probability. For example,
$p_X(3)=1/6$, whereas $p_X(7)=0$ and $7$ is outside the support.
The six probabilities add up to $6\cdot(1/6)=1$.
